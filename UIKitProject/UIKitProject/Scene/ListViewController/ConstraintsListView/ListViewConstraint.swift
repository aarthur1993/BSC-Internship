...
extension ListViewController {
    ...
    func constraintScroll() {
        scroll.centerXAnchor.constraint(equalTo: view.safeAreaLayoutGuide.centerXAnchor, constant: +0).isActive = true
        scroll.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: +52).isActive = true
        scroll.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -15).isActive = true
        scroll.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: +0).isActive = true
        scroll.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -0).isActive = true
    }
    // MARK: - Method constraintStackView
    func constraintStackView() {
        stackView.centerXAnchor.constraint(equalTo: scroll.safeAreaLayoutGuide.centerXAnchor,
        ...
        stackView.heightAnchor.constraint(equalToConstant: +750).isActive = true
        stackView.leadingAnchor.constraint(equalTo: scroll.leadingAnchor, constant: +16).isActive = true
        stackView.trailingAnchor.constraint(equalTo: scroll.trailingAnchor, constant: -16).isActive = true
    }
}
...
extension ListViewController {
    ...
    func constraintNote() {
        titleNote.centerXAnchor.constraint(
        ...
        titleNote.trailingAnchor.constraint(
            equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -100
        ).isActive = true
    }
    ...
    func constraintTextTime() {
        ...
        titlTime.trailingAnchor.constraint(
            equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -280
        ).isActive = true
    }
}
